    ...
    <div class="container">
        <div class="image-section">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                $imageDir = $_SERVER['DOCUMENT_ROOT'] . "/MathCanvas/student/starpentagon/process/" . $username;
                ...
                foreach ($sessionFolders as $index => $folder) {
                    ...
                    if (!empty($imageFiles)) {
                        ...
                        foreach ($imageFiles as $image) {
                            echo "<img src='/MathCanvas/student/starpentagon/process/" . $username . "/" . basename($folder) . "/" . basename($image) . "' alt='Image'>";
                        }
                        echo "</div>";
                    } else {
        ...
        <div class="review-section">
            <div class="section">
                ...
                $resultDir = $_SERVER['DOCUMENT_ROOT'] . "/MathCanvas/student/starpentagon/result/" . $username;
